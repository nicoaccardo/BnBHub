...
Sistemare le "è" sbagliate nelle mail inviate agli utenti.
...
? Possibile errore nella registrazione con conflitto tra codice fiscale già esistente e invio di mail di conferma registrazione, da verificare e sistemare se necessario.

Aggiungere una X per chiudere le notifiche di successo o errore che appaiono dopo le azioni dell'utente, in modo da permettere all'utente di chiuderle manualmente se lo desidera.
